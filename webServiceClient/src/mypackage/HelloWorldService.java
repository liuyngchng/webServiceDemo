 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:8080/webService/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/webService/services/HelloWorld?wsdl");
